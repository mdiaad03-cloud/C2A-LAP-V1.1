...
export default function App() {
  ...
  const navItems = useMemo(() => {
    ...
    if (isAdmin) {
      ...
      base.push({ key: "agent", label: tr("Agent", "\u0627\u0644\u0648\u0643\u064a\u0644"), icon: Bot });
          ...
          >
            ...
            {activeTab === "agent" && isAdmin ? (
              <AgentSection
                ...
                onGenerateProductDraft={generateAgentProductDraft}
                onCreateProduct={createProduct}
                onUploadProductImages={uploadProductImages}
                onGenerateSupportReply={generateAgentSupportReply}
                onReplyTicket={replySupportTicket}
                onUpdateTicket={updateSupportTicket}
                onUpdateOrder={updateOnlineOrder}
                onGenerateShippingDraft={generateAgentShippingDraft}
                lang={lang}
              />
            ) : null}

            {activeTab === "storeSettings" && isAdmin ? (
              <StoreSettingsSection settings={storeSettings} onSave={saveStoreSettings} lang={lang} />
            ) : null}
