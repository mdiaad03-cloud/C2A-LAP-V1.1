...
import { isMailConfigured, sendTestEmail } from "../services/emailService.js";
import { nowIso } from "../utils/dateUtils.js";
import { asOptionalText, requireEmail, requireText } from "../utils/validation.js";
...
router.post(
  ...
  authorize("admin"),
  asyncHandler(async (req, res) => {
    const to = requireEmail(req.body.to, "Recipient email");
    const subject = asOptionalText(req.body.subject);
    const body = asOptionalText(req.body.body);
