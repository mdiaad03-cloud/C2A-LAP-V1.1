...
async function ensureRequiredCollections() {
  ...
  db.storeSettings.agentSettings = {
    ...
    defaultShippingCompanyName:
      String(db.storeSettings.agentSettings?.defaultShippingCompanyName || "").trim()
      || defaultAgentSettings.defaultShippingCompanyName,
    defaultShippingStatus:
      String(db.storeSettings.agentSettings?.defaultShippingStatus || "").trim()
      || defaultAgentSettings.defaultShippingStatus,
    productDescriptionTone:
      String(db.storeSettings.agentSettings?.productDescriptionTone || "").trim()
      || defaultAgentSettings.productDescriptionTone,
    supportReplyTone:
      String(db.storeSettings.agentSettings?.supportReplyTone || "").trim()
      || defaultAgentSettings.supportReplyTone,
  };
